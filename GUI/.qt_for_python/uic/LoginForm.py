...
# Form implementation generated from reading ui file 'c:\Users\brend\wsl\BT2102-OSHES-Group16\GUI\XML UI files\LoginForm.ui'
#
...
"border-bottom-left-radius: 20px;")
        ...
        self.login_details_container.setGeometry(QtCore.QRect(420, 49, 791, 681))
...
"border-bottom-right-radius: 20px;")
        ...
        self.LoginTextContainer = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.username_enter.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(620, 540, 391, 81))
        ...
        self.register_now_button = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.register_now_button.sizePolicy().hasHeightForWidth())
...
"}")
    ...
    def retranslateUi(self, LoginForm):
        ...
        self.welcome_message.setText(_translate("LoginForm", "Welcome to Light & Locks!"))
        ...
        self.label_2.setText(_translate("LoginForm", "Don\'t Have An Account?"))
        self.register_now_button.setText(_translate("LoginForm", "Register Now!"))
